...
export class SingleTeam extends Component {
    constructor(props) {
        super(props);  
  ...
  this.api_url = 'http:/127.0.0.1:5000/'
    ...
    componentDidMount() {
        ...
        $('.makelead').click(function(){
            var uniqid = $('.staffUniqid').text()
            localStorage.removeItem('userMakeLead')
            localStorage.setItem('userMakeLead', uniqid)
            window.location.href = '/make/team/lead'
        })
            ...
            console.log(uniqid)
           axios.get("http://127.0.0.1:8000/inventory/admin/single/team/"+uniqid.split(":")[1], { headers: headers })
                .then(res => {
                    ...
                    <div className="modal-dialog" role="document">
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                ...
                                <button className='btn btn-success makelead' >Make User Lead </button>
