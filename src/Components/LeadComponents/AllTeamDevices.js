...
export class AllTeamDevices extends Component {
    ...
    componentDidMount() {
        ...
        const { teamUniqid } = (this.props.match.params);
        ...
        // $('.viewsdevices').on('click',function(){
            ...
            var data = {
                user_uniqid : uniqid,
                team_uniqid: teamUniqid.split(':')[1],
            }
            ...
            axios.post("http://127.0.0.1:8000/inventory/lead/team/shared/devices/", data, { headers: headers })
            .then(res => {
                console.log(res.data['allDevices'])
                var device = res.data['allDevices'];
                this.setState({
                    allDevices: res.data['allDevices'],
                    teamDetails: res.data['team_details']
                })
					...
					<div className="container more-top-padding allDevices">
						<div className="row">
							<div className="col-xs-12">
                                 ...
                                 <h2>All {teamDetails['name']} Devices</h2>
