...
import { MDBSelect } from '../pro/Select/Select';
import DataTableTable from './DataTableTable/DataTableTable';
import DataTableTableScroll from './DataTableTableScroll/DataTableTableScroll';
import DataTableEntries from './DataTableEntries/DataTableEntries';
import DataTableSearch from './DataTableSearch/DataTableSearch';
import DataTableInfo from './DataTableInfo/DataTableInfo';
...
class DataTable extends Component {
  ...
  render() {
    ...
    const tableClasses = classnames(
      'dataTables_wrapper dt-bootstrap4 pt-5',
      className
    );
    ...
    return (
      <div data-test='datatable' className={tableClasses}>
        ...
        {!scrollY && !scrollX && (
          <div className='row datatablecontent'>
            <DataTableTable
              autoWidth={autoWidth}
              bordered={bordered}
