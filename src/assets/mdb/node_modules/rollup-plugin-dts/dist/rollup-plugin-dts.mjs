...
import { isClassDeclaration, isFunctionDeclaration, isInterfaceDeclaration, isModuleDeclaration, isEnumDeclaration, isVariableStatement, isCallExpression, isObjectLiteralExpression, isPropertyAssignment, isIdentifier, sys, ScriptTarget, createCompilerHost, createProgram as createProgram$1, findConfigFile, readConfigFile, formatDiagnostic, parseJsonConfigFileContent, formatDiagnostics, isLiteralExpression, isPropertyAccessExpression, getCombinedModifierFlags, idText, SyntaxKind, isComputedPropertyName, isPropertyDeclaration, isPropertySignature, isIndexSignatureDeclaration, isMethodDeclaration, isMethodSignature, isConstructorDeclaration, isConstructSignatureDeclaration, isCallSignatureDeclaration, isGetAccessorDeclaration, isSetAccessorDeclaration, isTypeReferenceNode, isTypeLiteralNode, isArrayTypeNode, isTupleTypeNode, isParenthesizedTypeNode, isTypeOperatorNode, isTypePredicateNode, isUnionTypeNode, isIntersectionTypeNode, isMappedTypeNode, isConditionalTypeNode, isIndexedAccessTypeNode, isFunctionOrConstructorTypeNode, isImportTypeNode, isTypeQueryNode, isTypeNode, isInferTypeNode, isLiteralTypeNode, isStringLiteral, isModuleBlock, isTypeAliasDeclaration, isExportDeclaration, ModifierFlags, isExportAssignment, isImportDeclaration, NodeFlags, isNamedImports, createSourceFile, DiagnosticCategory, nodeModuleNameResolver } from 'typescript';
...
function getCompilerOptions(input) {
    ...
    const { options, errors } = parseJsonConfigFileContent(config, sys, dirName);
    if (errors.length) {
...
function createPrograms(input) {
    ...
    for (let main of input) {
        ...
        if (options.dirName === dirName) {
            ...
            const program = createProgram$1(inputs, compilerOptions, host);
...
const plugin = () => {
    ...
    return {
        ...
        resolveId(source, importer) {
            ...
            const { resolvedModule } = nodeModuleNameResolver(source, importer, {}, sys);
            if (!resolvedModule) {
                return;
            }
